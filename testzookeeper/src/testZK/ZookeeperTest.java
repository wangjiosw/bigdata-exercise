...
//		indicate : all servers 
		zooKeeper  = new ZooKeeper("node002:2181,node003:2181,node004:2181", SESSION_TIMEOUT, watcher);
	}
...
//			 result = zooKeeper.create("/zk002", "zk002data-e".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
			 result = zooKeeper.create("/zk001", "zk002data-e".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
			 Thread.sleep(30000);
		} catch (Exception e) {
